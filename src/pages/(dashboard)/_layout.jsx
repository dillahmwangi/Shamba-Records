  ...
  const sidebarItems = [
    {
      category: 'MANAGEMENT',
      items: [
        { icon: BarChart3, label: 'Dashboard', count: null, active: true, link: '/' },
        { icon: Users, label: 'Farmers', count: 847, active: false, link: '/farmers' },
        { icon: Wheat, label: 'Crops', count: '2.1k', active: false, link: '/crops' },
